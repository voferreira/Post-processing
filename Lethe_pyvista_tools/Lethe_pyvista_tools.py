#############################################################################
"""Lethe simulations post-processing with pyvista"""
#############################################################################
...
class Lethe_pyvista_tools():
    ...
    def read_lethe_to_pyvista(self, pvd_name):
        ...
        print(f'Written {self}.df_timestep from timestep = 0 to timestep = {len(self.list_vtu)}')
