...
ax0.plot(time_list, np.repeat(0.64130864, len(time_list)), '--r', label = 'Experimental (+/- 10%)')
ax0.fill_between(time_list, np.repeat(0.64130864, len(time_list))*0.9, np.repeat(0.64130864, len(time_list))*1.1, color = 'r', alpha = 0.3)
